...
import styles from "@/styles/servidores/SectionOneS.module.css";

const ServidorHeader = () => {
        ...
        <div className={styles.headerHomeContainer}>
          <div className={styles.headerHomeContent}>
            ...
            <div className={styles.headerHomeMobileMenuButton}>
              ...
              >
                {isMenuOpen ? (
                  <X className={styles.headerHomeIcon} />
                ) : (
                  <Menu className={styles.headerHomeIcon} />
                )}
              </button>
            </div>
          </div>
